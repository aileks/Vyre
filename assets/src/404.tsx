      ...
      <div class='m-auto w-full max-w-lg px-4 py-8 text-center sm:px-8'>
        <div class='rounded-xs border border-zinc-700 bg-zinc-800 p-6 shadow-md'>
          ...
          <div class='mt-6'>
            <a
              href='/'
              class='inline-block rounded-xs bg-violet-600 px-6 py-2 text-white transition-colors hover:bg-violet-700 focus:outline-2 focus:outline-offset-2 focus:outline-violet-400'
            >
              Return to Home
            </a>
          </div>
