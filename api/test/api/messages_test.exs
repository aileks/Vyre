defmodule Api.MessagesTest do
  ...
  describe "messages" do
    ...
    test "create_message/1 with valid data creates a message" do
      valid_attrs = %{timestamp: ~U[2025-03-11 15:15:00Z], content: "some content", edited: true, mentions_everyone: true}

      assert {:ok, %Message{} = message} = Messages.create_message(valid_attrs)
      assert message.timestamp == ~U[2025-03-11 15:15:00Z]
    ...
    test "update_message/2 with valid data updates the message" do
      message = message_fixture()
      update_attrs = %{timestamp: ~U[2025-03-12 15:15:00Z], content: "some updated content", edited: false, mentions_everyone: false}

      assert {:ok, %Message{} = message} = Messages.update_message(message, update_attrs)
      assert message.timestamp == ~U[2025-03-12 15:15:00Z]
  ...
  describe "private_messages" do
    ...
    test "create_private_message/1 with valid data creates a private_message" do
      valid_attrs = %{timestamp: ~U[2025-03-11 15:19:00Z], read: true, content: "some content"}

      assert {:ok, %PrivateMessage{} = private_message} = Messages.create_private_message(valid_attrs)
      assert private_message.timestamp == ~U[2025-03-11 15:19:00Z]
    ...
    test "update_private_message/2 with valid data updates the private_message" do
      private_message = private_message_fixture()
      update_attrs = %{timestamp: ~U[2025-03-12 15:19:00Z], read: false, content: "some updated content"}

      assert {:ok, %PrivateMessage{} = private_message} = Messages.update_private_message(private_message, update_attrs)
      assert private_message.timestamp == ~U[2025-03-12 15:19:00Z]
