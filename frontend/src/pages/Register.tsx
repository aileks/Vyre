    ...
    <div class='bg-midnight-700 shadow-midnight-900/50 mx-auto mt-64 max-w-lg rounded-xs border border-gray-700 p-7 shadow-lg'>
      ...
      <form onSubmit={handleSubmit} class='space-y-4'>
        ...
        <button
          type='submit'
          disabled={isLoading()}
          class='text-cybertext-100 mt-6 w-full rounded-xs border border-pink-400 bg-pink-600 px-4 py-2.5 transition-all duration-200 hover:cursor-pointer hover:bg-pink-500 focus:ring-2 focus:ring-pink-500/50 focus:outline-none disabled:opacity-70'
        >
          {isLoading() ?
